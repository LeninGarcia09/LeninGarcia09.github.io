...
| AI Threat Model | STRIDE, MITRE ATLAS, risk analysis | Security architecture |
| Zero Trust Assessment | Framework application, governance | Strategic thinking |
| Prompt Library | Prompt engineering, documentation | AI enablement |
| Responsible AI Assessment | NIST AI RMF, compliance | AI governance |
| Security Incident Assistant | Python, OpenAI API, full-stack | AI development |
| Risk Assessment Assistant | Python, frameworks, reporting | AI + compliance |
...
**Headline (120 chars):**
```
AI Program Manager | Cloud Security | AI Governance (NIST AI RMF) | Azure Certified | Seeking New Opportunity
```
...
```
NOMBRE COMPLETO
AI Program Manager | Cloud Security | AI Governance
...
TECHNICAL SKILLS
AI & ML: Generative AI, RAG, Prompt Engineering, LLM Evaluation
Cloud: Azure AI Foundry, Azure OpenAI, Azure AI Search
Security: Zero Trust, Threat Modeling, SOC Operations, SIEM
Governance: NIST AI RMF, ISO 42001, Responsible AI
Tools: Python, SQL, Power BI, Power Automate, Git/GitHub
Frameworks: STRIDE, MITRE ATT&CK, MITRE ATLAS, OWASP

PROJECTS (seleccionar 3-4 mejores)
[Nombre del Proyecto] | [Tech Stack]
- Descripción orientada a resultados
- Métricas o impacto demostrable

PROFESSIONAL EXPERIENCE
[Reformular experiencia anterior con keywords modernos]
...
Soy [tu nombre], profesional de IT y ciberseguridad 
transitioning hacia AI Program Management. Vi tu perfil 
...
¿Tendrías 15 minutos para un coffee chat virtual?

Gracias,
[Tu nombre]
```

### Template: Cover Letter Opening
...
expertise that [Company] needs for the [Role] position.
```
