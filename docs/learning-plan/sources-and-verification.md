...
|---------------|--------|--------------|---------------|-----------------|
| Azure Fundamentals | AZ-900 | $99 (+ taxes) | Spanish available | [learn.microsoft.com](https://learn.microsoft.com/es-es/credentials/certifications/azure-fundamentals/) |
| Security, Compliance & Identity Fundamentals | SC-900 | $99 (+ taxes) | Spanish available | [learn.microsoft.com](https://learn.microsoft.com/es-es/credentials/certifications/security-compliance-and-identity-fundamentals/) |
| Azure AI Fundamentals | AI-900 | $99 (+ taxes) | Spanish available | [learn.microsoft.com](https://learn.microsoft.com/es-es/credentials/certifications/azure-ai-fundamentals/) |
| GitHub Foundations | GH-900 | $99 (free prep) | English | [learn.microsoft.com](https://learn.microsoft.com/es-es/credentials/certifications/github-foundations/) |
| Azure AI Apps and Agents Developer Associate | **AI-103** | verify on official page | Verify | [learn.microsoft.com](https://learn.microsoft.com/en-us/credentials/certifications/azure-ai-apps-and-agents-developer-associate/) |

:::danger[AI-102 retired on June 30, 2026 — use AI-103]
Microsoft **retired the AI-102 exam** on **Jun 30, 2026**. Its successor is **AI-103 — Azure AI Apps and Agents Developer Associate** (generative AI apps + multi-agent solutions with Microsoft Foundry, in Python). Official page: [AI-103](https://learn.microsoft.com/en-us/credentials/certifications/azure-ai-apps-and-agents-developer-associate/) · [AI-103 study guide](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/ai-103). **Confirm status (beta/GA), price, and *skills measured* on the official page before scheduling.**
:::

:::warning[About AI-103 for this profile]
...
|------|--------|---------------|--------|--------------------------------------|
| AIGP — AI Governance Professional | IAPP | None | English | [iapp.org/certify/aigp](https://iapp.org/certify/aigp) |
| PMI-CPMAI — Managing AI | PMI | None | **Spanish (LATAM)** + 9 more | [pmi.org](https://www.pmi.org/certifications/ai-project-management-cpmai) |
| CEET — Certified Ethical Emerging Technologist | CertNexus | None | English | [certnexus.com](https://certnexus.com/certified-ethical-emerging-technologist-ceet/) |
| AAIA — Advanced in AI Audit | ISACA | ⚠️ **Requires CISA** (or another equivalent audit designation) | English | [isaca.org/credentialing/aaia](https://www.isaca.org/credentialing/aaia) |
| Lead Auditor ISO/IEC 42001 | Various (accredited) | None | Varies | [iso.org/standard/81230](https://www.iso.org/standard/81230.html) |
| CC — Certified in Cybersecurity | ISC2 | None | Spanish available | [isc2.org](https://www.isc2.org/certifications/cc) |
| Security+ | CompTIA | None | Spanish available | [comptia.org](https://www.comptia.org/certifications/security) |

:::warning[Verification of prerequisites and names]
...
- Prices: vendor-neutral exams change price frequently; the ranges in the [Plan Overview](./overview) are directional (~AIGP $649–799, ~CPMAI $699 + membership, ~CEET $270–350, ~AAIA $459–599). **Confirm at the official source.**
:::

---

:::note[Currency guardrail]
...
| Google AI Essentials | Google | Low cost (free Coursera audit) | Paid | [grow.google/ai-essentials](https://grow.google/ai-essentials/) |
| AI for Everyone (Andrew Ng) | DeepLearning.AI (Coursera) | **Free audit** | Paid | [coursera.org](https://www.coursera.org/learn/ai-for-everyone) |
| Generative AI for Everyone | DeepLearning.AI (Coursera) | **Free audit** | Paid | [deeplearning.ai](https://www.deeplearning.ai/courses/generative-ai-for-everyone/) |
| AI learning paths | Microsoft Learn | **Free** | Free (badges/Applied Skills) | [learn.microsoft.com](https://learn.microsoft.com/es-es/training/) |
| Official prep + Practice Assessments | Microsoft Learn | **Free** | N/A | [learn.microsoft.com](https://learn.microsoft.com/es-es/credentials/browse/) |
| Python para Todos (Py4E) | Univ. of Michigan (Dr. Chuck) | **Free** | Optional | [py4e.com](https://www.py4e.com/) |
| GitHub Skills | GitHub | **Free** | N/A | [skills.github.com](https://skills.github.com/) |
...
Foundation of the [Challenge Track: Applied AI Security](./challenges-ai-security/overview). All are open source and runnable on your own machine.

| Tool / Resource | What it does | Cost | Primary source (verified 2026-07) |
|-----------------------|----------|-------|--------------------------------------|
| OWASP Top 10 for LLM Apps | The 10 security risks for LLMs | Free | [genai.owasp.org](https://genai.owasp.org/llm-top-10/) |
| MITRE ATLAS | Adversarial TTPs against AI/ML systems | Free | [atlas.mitre.org](https://atlas.mitre.org/) |
| NIST AI RMF + GenAI Profile (600-1) | AI risk management framework | Free | [nist.gov](https://www.nist.gov/itl/ai-risk-management-framework) · [600-1](https://doi.org/10.6028/NIST.AI.600-1) |
...
The **free stack** (Elements of AI + Microsoft Learn + Py4E + GitHub Skills + official practice assessments) covers almost the whole plan at no cost. The only mandatory spend is the **certification exams (~$99 each)** — and Microsoft periodically offers **free vouchers** through *Virtual Training Days*. Check the [Microsoft Learn events page](https://learn.microsoft.com/es-es/training/) before paying.
:::
...
[Methodology and Best Practices](./methodology-best-practices) is based on these primary sources:
...
| 70-20-10 model | Experience/social/formal balance in leader development | Framework (CCL) | [ccl.org](https://www.ccl.org/articles/leading-effectively-articles/70-20-10-rule/) |
...
| Google Career Certificates | Design with projects + capstone + employer consortium | Reference program | [grow.google/certificates](https://grow.google/certificates/) |
| AWS re/Start | Cohort design + scenario labs | Reference program | [aws.amazon.com](https://aws.amazon.com/training/restart/) |
| IBM SkillsBuild | Project-based learning + stackable credentials | Reference program | [skillsbuild.org](https://skillsbuild.org/) |
...
|------|--------|------|-----------------|
| Job postings requiring AI skills pay an **~28% salary premium (~$18k/year)** | Lightcast (2025) | Market report | [lightcast.io](https://lightcast.io/resources/blog/the-generative-ai-job-market-2025-data-insights) |
| **~Half** of postings requiring AI skills are already **outside IT** (HR, finance) | Indeed Hiring Lab (Jun 2025) | Market report | [hiringlab.org](https://www.hiringlab.org/2025/06/17/the-rise-of-responsible-ai-jobs/) |
| Average total compensation in AI privacy/governance ~**$200k**; median AI governance specialist ~**$152k** | IAPP (2025–26) | Survey report | [iapp.org](https://iapp.org/resources/article/infographic-salary-and-jobs-report/) |

:::note[About WEF statistics]
...
:::warning[About the 70-20-10 model]
...
Official resources and credentials for the [priority Copilot Studio module](./foundation/overview) in Phase 1. Copilot Studio evolves quickly (autonomous agents, generative actions); **re-verify before scheduling a credential**.

| Resource / Credential | Type | Cost | Primary source |
|----------------------|------|-------|-----------------|
| Official Copilot Studio documentation | Docs | Free | [learn.microsoft.com](https://learn.microsoft.com/es-es/microsoft-copilot-studio/) |
| Learning Path: *Create agents in Microsoft Copilot Studio* (9 modules) | Learning Path with labs | Free | [learn.microsoft.com](https://learn.microsoft.com/en-us/training/paths/create-extend-custom-copilots-microsoft-copilot-studio/) |
| Copilot Studio Agent Academy | Practical curriculum | Free | [microsoft.github.io/agent-academy](https://microsoft.github.io/agent-academy/) |
| Agent in a Day — Workshop | Guided workshop | Free | [learn.microsoft.com](https://learn.microsoft.com/en-us/training/paths/agents-online-workshop/) |
| **Applied Skill:** Create agents in Microsoft Copilot Studio | Credential (interactive lab) | Free / low cost | [learn.microsoft.com](https://learn.microsoft.com/en-us/credentials/applied-skills/create-agents-in-microsoft-copilot-studio/) |
| **Applied Skill:** Enhance agents with autonomous capabilities | Credential (interactive lab) | Free / low cost | [learn.microsoft.com](https://learn.microsoft.com/en-us/credentials/applied-skills/enhance-agents-with-autonomous-capabilities/) |
| Copilot Studio Samples | Sample code | Free | [github.com/microsoft/CopilotStudioSamples](https://github.com/microsoft/CopilotStudioSamples) |

:::note[About Applied Skills]
...
The salary ranges in the [Plan Overview](./overview) are **directional (U.S. market, 2025-2026)**, not guarantees. They vary strongly by country, industry, company size, and seniority. For role/region-specific figures, consult live data sources such as:
...
- **Design frameworks:** the 70-20-10 model (CCL) and WEF *Future of Jobs 2025* data support the [methodology](./methodology-best-practices); the 70/20/10 proportions are a guiding philosophy, not a validated formula, and WEF statistics are survey data with year/source cited.
